        ...
        if k == 'kind':
            ...
            for i in range(len(value_list)):
                ...
                if k == 'tag':
                    ...
                    container['lifecycle']['mSvcStatus']['exec'] = "curl --fail --silent http://127.0.0.1:" + value_list[i] + "/getstatus"
                    container['lifecycle']['mSvcDown']['exec'] = "curl --fail --silent http://127.0.0.1:" + value_list[i] + "/down"
                    container['lifecycle']['mSvcUp']['exec'] = "curl --fail --silent http://127.0.0.1:" + value_list[i] + "/up"
                else:
