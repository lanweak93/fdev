...
<head>
    ...
    <style>
        ...
        /*--header start here--*/
        .newsletter {
            <#--background: url(http://10.134.13.25:8080/${path}/banner.png) no-repeat;-->
...
<div class="newsletter">
    <div class="newsletter-main">
        ...
        <div class="design">
            <img src="http://10.134.13.25:8080/${path}/design.png"/>
        </div>
        <br><br>
        <#include "/${template_name}.ftl"/>
        <div class="design">
            <img src="http://10.134.13.25:8080/fuser/design.png"/>
        </div>
        <div class="clear"></div>
    </div>
    <div class="copy-right" style="margin-left: 5%;margin-right: 5%">
        <p style="color: black;">提示：请不要对此邮件直接回复，系统看不懂您的回信^_^。如果您有建议或意见，请回复
            <a href="mailto:csii_wuj@spdbdev.com" style="text-decoration:none; color:blue;">csii_wuj@spdbdev.com</a></p>
    </div>
</div>
