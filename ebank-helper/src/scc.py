...
class Scc:
    ...
    def init_scc_env_var(self, env_slug):
        self.FDEV_SCC_URL = "http://10.136.52.174:8080"
        ...
        # self.HARBOR_ADDRESS = '10.191.32.8'
    ...
    def query_yaml_envs(self):
        cur_envs = []
        # url = "http://10.136.52.174:8080/scc/deployment/curYaml?namespaceCode=effapp-sit&userGroupCode=spdb&resourceCode=eff-web-iams&resourceKind=Deployment&clusterCode=k8-phy-b01&userId=fdev"
        url = "http://10.136.52.174:8080/scc/deployment/curYaml?namespaceCode=%s&userGroupCode=%s&resourceCode=%s&resourceKind=Deployment&clusterCode=%s&userId=%s"
    ...
    def replace_env(self, deployment_str):
        ...
        esf_config = None
        try:
            url = "http://10.129.125.83:7701/api/batchChange/queryIamsConfigByName"
