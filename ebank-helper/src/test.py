...
if __name__ == '__main__':
    url = "http://10.134.102.90:7701/api/batchChange/queryIamsConfigByName"
    ...
    # a = content.replace("$<spdbservice_esb_info.domain_retail>", "10.129.125.83")
    # print a
    ...
    #         newConfig["value"] = "http://10.114.58.238"
    #     else:
    #         newEnvs.append(item)
