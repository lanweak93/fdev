...
class Deploy:
    def __init__(self):
        ...
        self.token = "zYLLssdksXadybd3nCm8"
        self.sit_token = "cYA3n_GQHwboeqMQdDFP"
        ...
        # # http://10.129.40.170/api/v4/projects/26475/repository/
    ...
    def get_fdev_slug(self, CI_FDEV_ENV):
        fdev_url = "http://10.134.13.25:8080"
        # fdev uat 接口地址
        fdev_uat_url = "http://10.134.13.25:9092"
        # fdev sit 接口地址
        fdev_sit_url = "http://10.134.13.25:9093"
        # fdev rel 接口地址
        fdev_rel_url = "http://10.134.13.25:9091"
