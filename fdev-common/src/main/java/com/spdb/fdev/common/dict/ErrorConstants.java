/**
 * ErrorConstants.java Created on Mon Dec 13 11:25:25 CST 2021
 * 
...
/**
 * FDEV系统错误字典文件
 * Creation date: (Mon Dec 13 11:25:25 CST 2021)
...
/**  用户权限不足  */
    public static final String USER_PERMISSION_LIMIT="COMM008";
/**  用户认证失败  */
