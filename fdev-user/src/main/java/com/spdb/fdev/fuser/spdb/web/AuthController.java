...
public class AuthController {
    ...
    @ApiImplicitParam(name = "user", value = "例如:{\"user_name_en\":\"csii_huanghx\",\"password\":\"spdb@1234\"}")
    ...
    @ApiImplicitParam(name = "object", value = "例如:{\"emile\":\"csii_haunghx@spdbdev.com\"}")
    ...
    @ApiImplicitParam(name = "object", value = "例如:{\"password\":\"spdb@1234\",\"emile\":\"csii_haunghx@spdbdev.com\",\"code\":\"adcv\"}")
    ...
    @ApiImplicitParam(name = "object", value = "例如:{\"password\":\"spdb@1234\",\"gitLable\":\"a1aEQCizUD5VDYXWpojh\"}")
    ...
    @ApiImplicitParam(name = "oAuth", value = "例如:{\"name\":\"svn\",\"host\":\"http://10.129.13.25:8080/svn\"}")
