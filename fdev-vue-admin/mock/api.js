...
const env = [
  {
    ...
    var_list: [
      ...
      },
      {
        ...
        value: 'http://ebank:spdb1234@ebankconfsh1.spdbbiz.com:9804',
...
const pipelines = [
  {
    ...
    ref: 'SIT',
    status: 'success',
    web_url: 'http://10.129.40.170/ebank/devops/fdev-task/pipelines/29898'
  },
  {
    id: 29811,
    ...
    ref: 'UAT',
    status: 'failed',
    web_url: 'http://10.129.40.170/ebank/devops/fdev-task/pipelines/29811'
  },
  {
    id: 29422,
    ...
    ref: 'SIT',
    status: 'canceled',
    web_url: 'http://10.129.40.170/ebank/devops/fdev-task/pipelines/29422'
  }
];
