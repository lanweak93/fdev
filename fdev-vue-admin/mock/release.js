const plan = [
  {
    applications: [],
    assets_giturl: 'http://10.136.35.116:8080/ebank/devops/testassets-sit/',
...
const release = [
  {
    create_user: '5daff62cf57ddb001047b484',
    create_user_name_cn: '冼绮静',
    create_user_name_en: 'csii_xianqj',
    node_status: '3',
    owner_groupId: '3',
    owner_group_name: '3',
    release_date: '2020-10-29',
    release_manager: 'csii_xianqj',
    release_manager_id: '5daff62cf57ddb001047b484',
    release_manager_name_cn: '冼绮静',
    release_node_name: '20201029_001',
    release_spdb_manager: 'csii_xianqj',
    release_spdb_manager_id: '5daff62cf57ddb001047b484',
    release_spdb_manager_name_cn: '冼绮静'
  }
];
...
const system = [
  {
    ...
    system_abbr: '111',
    resource_giturl: [
      'http://10.136.35.116:8080/ebank/devops/testGroup/msper-web-yingyong'
    ],
...
const template = [
  {
    ...
    temp_giturl:
      'http://10.136.35.116:8080/ebank/devops/prodtemplate-sit/blob/master/变更管理_20191022_19KF441413.xls',
  ...
  },
  {
    ...
    temp_giturl:
      'http://10.136.35.116:8080/ebank/devops/prodtemplate-sit/blob/master/测试流程.xlsx',
    update_user: '5daff409f57ddb001047b480',
  ...
  },
  {
    ...
    owner_app: '5daff7dd2ab58a0010da56d4',
    temp_giturl:
      'http://10.136.35.116:8080/ebank/devops/prodtemplate-sit/blob/master/20191017投产清单案例.xlsx',
    update_user: '5daff409f57ddb001047b480',
  ...
  },
  {
    ...
    owner_app: null,
    temp_giturl:
      'http://10.136.35.116:8080/ebank/devops/prodtemplate-sit/blob/master/变更管理_个人网银系统微服务_20190603 (1).xls',
    update_user: '5daff4cbf57ddb001047b482',
    update_time: '2019-10-24 15:51:58',
    file_md5: '6a1f69da0ac2b8a75816438e2b6c7590',
    status: null,
    update_username_cn: '汪军',
    owner_app_name: '',
    owner_system_name: '个人手机',
    catalogs: [
      {
          ...
          children: [
            {
              ...
              asset_url:
                'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/commonconfig/DEV/test/1575597485788.jpg'
            }
          ],
          catalog_type: '',
          catalog_description: ''
          ...
          children: [
            {
              asset_name: 'test/1575597485788.jpg',
              asset_url:
                'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/commonconfig/TEST/test/1575597485788.jpg'
            }
          ],
          catalog_type: '',
          catalog_description: ''
          ...
          children: [
            {
              asset_name: 'test/1575597485788.jpg',
              asset_url:
                'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/commonconfig/TCYZ/test/1575597485788.jpg'
            }
          ],
          catalog_type: '',
          catalog_description: ''
          ...
          children: [
            {
              asset_name: 'test/1575597485788.jpg',
              asset_url:
                'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/commonconfig/PROCSH/test/1575597485788.jpg'
            }
          ],
          catalog_type: '',
          catalog_description: ''
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          asset_url:
            'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/db_mbank/IMG_5997.JPG'
        }
      ],
      catalog_type: '3',
      ...
      children: [
        {
          ...
          asset_url:
            'http://10.136.35.116:8080/ebank/devops/testassets-sit/20201101_001/DOCKER_9D_20201104_1430/tree/master/config/touchbarpet.app.zip'
        }
      ],
      catalog_type: '4',
