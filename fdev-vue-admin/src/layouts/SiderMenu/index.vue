...
export default {
  ...
  created() {
    if (window.location.origin === 'http://10.134.13.25:9093') {
      this.envName = 'SIT测试环境';
    } else if (window.location.origin === 'http://10.134.13.25:9092') {
      this.envName = 'UAT测试环境';
    } else if (window.location.origin === 'http://10.134.13.25:9091') {
      this.envName = '准生产环境';
    } else if (window.location.origin === 'http://10.134.13.25:8080') {
      this.envName = '';
    } else {
      this.envName = '本地测试环境';
    }
