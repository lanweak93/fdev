  ...
  &quot;extra&quot;: {
    ...
    &quot;create_time&quot; : &quot;&quot;                  //录入时间
      ...
      <ol>
        <li>
          <a
            href="http://10.129.40.170/ebank_fdev/fdev_issuses/issues/50"
            target="_blank"
            >http://10.129.40.170/ebank_fdev/fdev_issuses/issues/50
          </a>
        </li>
        <li>
          <a href="http://10.134.13.25/common/xndp9/vue" target="_blank"
            >http://10.134.13.25/common/xndp9/vue
          </a>
        </li>
      </ol>
    </div>
