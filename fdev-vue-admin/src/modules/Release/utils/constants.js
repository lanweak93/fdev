...
export const mapIpList = {
  commonconfig: {
    'gray-phone-sh': ['10.100.165.30'],
    'gray-phone-hf': ['10.119.165.30'],
    'gray-network-sh': ['10.100.165.30'],
    'gray-network-hf': ['10.119.165.30'],
    'proc-phone-sh': [
      '10.100.165.31',
      '10.100.165.32',
      '10.202.170.133',
    ...
    'proc-batch-sh': ['10.240.152.55', '10.240.152.56'],
    'proc-batch-hf': ['10.122.186.174', '10.122.186.175'],
    'proc-otc-sh': [
      '10.202.150.249',
      '10.202.150.250',
      '10.202.140.15',
  ...
  cfg_nas: {
    'gray-phone-sh': ['10.202.170.155'],
    'gray-phone-hf': ['10.122.170.155'],
    'gray-network-sh': ['10.100.165.124'],
    'gray-network-hf': ['10.100.165.125'],
    'proc-phone-sh': ['10.202.170.155'],
    'proc-phone-hf': ['10.122.170.155'],
    'proc-network-sh': ['10.202.170.155'],
    'proc-network-hf': ['10.122.170.155'],
    'proc-batch-sh': ['10.202.170.155'],
    'proc-batch-hf': ['10.122.170.155'],
    'proc-otc-sh': ['10.202.170.155'],
    'proc-otc-hf': ['10.122.170.155']
  },
  cfg_core: {
    'gray-phone-sh': ['10.100.165.30', '10.202.170.155'],
    'gray-phone-hf': ['10.119.165.30', '10.122.170.155'],
    'gray-network-sh': ['10.100.165.30', '10.100.165.124'],
    'gray-network-hf': ['10.119.165.30', '10.100.165.125'],
    'proc-phone-sh': [
      '10.100.165.31',
      '10.100.165.32',
      '10.202.170.133',
    ...
    'proc-batch-sh': ['10.240.152.55', '10.240.152.56', '10.202.170.155'],
    'proc-batch-hf': ['10.122.186.174', '10.122.186.175', '10.122.170.155'],
    'proc-otc-sh': [
      '10.202.150.249',
      '10.202.150.250',
      '10.202.140.15',
