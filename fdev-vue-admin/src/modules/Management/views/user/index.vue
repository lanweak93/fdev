...
export default {
  ...
  data() {
    return {
      ...
      groupsCopy: [],
      validated: [],
      emailAppend: ['@spdb.com.cn', '@spdbdev.com'],
    ...
    userModel: {
      ...
      email_pre: {
        ...
        ldapLogin(val) {
          ...
          return this.userModel.email_append === '@spdbdev.com';
        }
      },
      email_append: {
        required
    ...
    'userModel.email_append': {
      ...
      handler: function(val) {
        if (val) {
          ...
          this.$v.userModel.email_append.$model = '@spdb.com.cn';
        }
        if (this.$v.userModel.email_append.$model === '@spdb.com.cn') {
