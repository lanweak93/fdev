...
export const websiteList = {
  total: [
    ...
    },
    {
      iconEn: 'iams',
      name: '挡板(iams)',
      url: 'http://10.134.13.25:8080/iams/'
    },
    {
      iconEn: 'ftms',
      name: '玉衡测试管理平台(ftms)',
    ...
    {
      name: '接口管理工具(yapi)',
      url: 'http://10.134.13.25:9999/login',
      tooltip: '只能在虚拟机内访问',
      iconEn: 'yapi'
    },
    ...
    {
      name: 'ESB对外小工具',
      url: 'http://10.134.6.56:9001/',
      tooltip: '只能在虚拟机内访问',
      iconEn: 'esb'
    },
    {
      name: 'mantis',
      url: 'http://10.134.13.25:9004/login_page.php',
      tooltip: '只能在虚拟机内访问',
      iconEn: 'mantis'
    },
    {
      name: 'speed4J',
      url: 'http://10.134.15.159:7080',
      iconEn: 'speed4j'
    },
    {
      name: 'learn lab',
      url: 'http://10.134.107.70',
      tooltip: '只能在虚拟机内访问',
      iconEn: 'learnlab'
    },
    {
    ...
    {
      name: 'mpaas 画板介绍',
      url: 'http://10.134.13.24:8080/resource/index.html',
      iconEn: 'mpaas'
    },
    {
      name: 'fdev issue',
      url: 'http://10.129.40.170/ebank_fdev/fdev_issuses/-/issues',
      tooltip: '只能虚拟机内访问',
      iconEn: 'fdevIssue'
    },
    {
      name: '应用架构issue',
      url: 'http://10.129.40.170/ebank_fdev/AppArch_issues/-/issues',
      tooltip: '只能虚拟机内访问',
      iconEn: 'afIssue'
    },
    {
    ...
    {
      name: 'mpaas issue',
      url: 'http://10.129.40.170/ebank/mpaas-issues/issues',
      tooltip: '只能虚拟机内访问',
      iconEn: 'mpaasIssue'
    },
    {
    ...
    {
      name: '云测试平台',
      url: 'http://10.114.11.198/xtest/login.jsp',
      iconEn: 'xtest'
    },
    {
      name: '浦天开物',
      url: 'http://10.134.15.159:7080/speedstudio/',
      iconEn: 'speedstudio'
    },
    {
      iconEn: 'usermanual',
      name: 'fdev用户手册',
      url: 'http://10.134.13.24:8080/view/l/teu8564'
    },
    {
      iconEn: 'codesearch',
      name: '代码搜索',
      url: 'http://10.134.13.25:9008',
      tooltip: '只能虚拟机内访问'
    },
    {
      iconEn: 'conflunce',
