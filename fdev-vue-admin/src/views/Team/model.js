export const list = {
  IntegratedArch: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank_fdev/IntegratedArch_issues/issues',
      item: [
    ...
    knowledge: [
      {
        title: '集成架构知识库',
        url: 'http: //10.134.13.25/common/hf14k'
      }
    ],
    thanks: [],
    scan: [
      'http://10.129.40.170/ebank/devops/fdev-config-test/raw/master/congfig-repo/WechatIMG1.jpeg',
      'http://10.129.40.170/ebank/devops/fdev-config-test/raw/master/congfig-repo/IMG_6585.JPG'
    ]
  },
  AppArch: {
    introduce: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank_fdev/AppArch_issues/issues',
      item: [
        '描述环境信息: 操作系统及版本、中间件及版本',
        '问题相关日志。',
        '问题复现条件'
  ...
  AppDev: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank_fdev/AppDev_issues/issues',
      item: ['建议来源，改进方向。', '问题相关日志。', '环境信息及问题复现。']
    },
    knowledge: [
      {
        title: '基础应用知识库',
        url: 'http://10.134.13.25/common/6f70k'
      }
    ],
    thanks: [],
    scan: [
  ...
  mpaas: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank/mpaas-issues/issues/issues',
      item: [
        '有关Mpaas团队的问题和建议。',
        '业务开发支持需求。',
        '性能优化支持需求。'
    ...
    knowledge: [
      {
        title: 'mpass 服务规范',
        url: 'http://10.134.13.25/mpaas/anm7r'
      },
      {
        title: 'mpass 组件库',
        url: 'http://10.134.13.25/mpaas/xyeo'
      },
      {
        title: 'mpass UI设计',
        url: 'http://10.134.13.25/mpaas/08e2o'
      }
    ],
    thanks: [],
    scan: [
  ...
  fdev: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank_fdev/fdev_issuses/issues',
      item: [
        '描述具体使用/操作的过程',
        '问题相关日志、截图',
        '问题复现条件',
    ...
    knowledge: [
      {
        title: 'fdev 相关接入手册',
        url: 'http://10.134.13.25/common/xndp9/82jl'
      }
    ],
    thanks: [
      {
  ...
  finance: {
    ...
    issue: {
      main: 'http://10.129.40.170/ebank/ent/micro_ent_issues/-/issues',
      item: ['问题相关日志', '问题相关截图', '问题复现条件']
    },
    knowledge: [
      {
        title: '团队文档地址',
        url: 'http://10.129.40.170/ebank/ent/doc'
      },
      {
        title: '应用架构知识库',
        url: 'http://10.134.13.25/apparch/'
      ...
      {
        title: '投产发布说明及相关介质',
        url: 'http://10.129.40.170/ebank/ent/release-notes'
      }
    ],
    thanks: [],
    scan: []
