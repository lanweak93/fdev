...
class Build:
    ...
    def main(self):
        ...
        # CI_REGISTRY_IMAGE = 10.136.35.117/library/fdev-app

        # SIT 分支 -> 镜像打到 10.136.35.117/fdev-sit/fdevapp:piplineid
        # release 分支 -> 镜像打到 10.136.35.117/fdev-uat/fdevapp:piplineid
        # pro tag 分支 -> 镜像打到 10.136.35.117/fdev-rel/fdevapp:piplineid
        # pro tag 分支 并且是投产 -> 镜像打到 10.136.35.117/fdev-prod/fdevapp:piplineid
