...
//		StringBuffer privateConfig = new StringBuffer();
			...
			if (systemName.contains("个人手机") && !systemName.contains("村镇")) {
				...
				if ("gray".equals(type)) {
					...
					if (cfgNasFlag) {
						...
						if("1".equals(city)) {
							cfgNas.append("SH IP：10.100.165.124").append("\r\n");
						}else if("2".equals(city)) {
							cfgNas.append("HF IP：10.100.165.125").append("\r\n");
						} else {
							cfgNas.append("SH IP：10.100.165.124").append("\r\n");
							cfgNas.append("HF IP：10.100.165.125").append("\r\n");
						}
					...
					if (appNasFlag) {
						...
						if("1".equals(city)) {
							appNas.append("SH IP：10.100.165.124").append("\r\n");
						}else if("2".equals(city)) {
							appNas.append("HF IP：10.100.165.125").append("\r\n");
						} else {
							appNas.append("SH IP：10.100.165.124").append("\r\n");
							appNas.append("HF IP：10.100.165.125").append("\r\n");
						}
				...
				if ("proc".equals(type)) {
					if (commonconfigFlag) {
						...
						String city = commonconfig.getCity();
						if("1".equals(city)) {
							publicConfig.append("SH IP：K1:(10.202.150.249-250)K2:(10.202.140.15-16)").append("\r\n");
						}else if("2".equals(city)) {
							publicConfig.append("HF IP：K1:(10.122.144.249-250)K2:(10.122.140.15-16)").append("\r\n");
						} else {
							publicConfig.append("SH IP：K1:(10.202.150.249-250)K2:(10.202.140.15-16)").append("\r\n");
							publicConfig.append("HF IP：K1:(10.122.144.249-250)K2:(10.122.140.15-16)").append("\r\n");
						}
				...
				if ("proc".equals(type)) {
					if (commonconfigFlag) {
						...
						String city = commonconfig.getCity();
						if("1".equals(city)) {
							publicConfig.append("SH IP：K1:(10.240.152.55-56)").append("\r\n");
						}else if("2".equals(city)) {
							publicConfig.append("HF IP：K1:(10.122.186.174-175)").append("\r\n");
						} else {
							publicConfig.append("SH IP：K1:(10.240.152.55-56)").append("\r\n");
							publicConfig.append("HF IP：K1:(10.122.186.174-175)").append("\r\n");
						}
	...
	public StringBuffer generateSqlInfo(List<NoteSql> noteSqlList,String id) {
		...
		if(!Util.isNullOrEmpty(noteSqlList)) {
			...
			if(!Util.isNullOrEmpty(dbbefMbank)) {
				...
				dbbefMbankSb.append("IP:").append("10.200.183.172").append("\r\n");
			...
			if(!Util.isNullOrEmpty(dbmidMbank)) {
				...
				dbmidMbankSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbaftMbank)) {
				...
				dbaftMbankSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbbefNbper)) {
				...
				dbbefNbperSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbmidNbper)) {
				...
				dbmidNbperSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbaftNbper)) {
				...
				dbaftNbperSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbbefOracle)) {
				...
				dbbefOracleSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbmidOracle)) {
				...
				dbmidOracleSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
			...
			if(!Util.isNullOrEmpty(dbaftOracle)) {
				...
				dbaftOracleSb.append("IP:").append("10.200.183.172").append("\r\n");
				StringBuffer execSql = new StringBuffer();
				StringBuffer backSql = new StringBuffer();
		...
		if(!Util.isNullOrEmpty(confList)) {
			...
			sb.append("IP:").append("10.200.183.172").append("\r\n");
	...
	public StringBuffer generateServiceInfo(List<NoteService> noteServiceList,String prodType,String leaseholder) {
		...
		sb.append("    ").append("CaaS地址:https://10.202.150.11/index.html#/app-list/all(上海)").append("\r\n");
		sb.append("    ").append("CaaS地址:https://10.122.144.11/index.html#/app-list/all(合肥)").append("\r\n");
		...
		sb.append("    ").append("CaaS地址:https://10.202.152.11/index.html#/app-list/all(上海)").append("\r\n");
		sb.append("    ").append("CaaS地址:https://10.122.154.11/index.html#/app-list/all(合肥)").append("\r\n");
		if("gray".equals(prodType)) {
			sb.append("    ").append("上海CaaS应用用户(灰度)：").append(userNameSH).append("\r\n");
			sb.append("    ").append("合肥CaaS应用用户(灰度)：").append(userNameHF).append("\r\n");
		}else if("proc".equals(prodType)) {
	...
	public StringBuffer generateBatchInfo(List<BatchTaskInfo> batchTaskInfos,String note_id) throws Exception {
		...
		sb.append("\r\n");
		sb.append("4.1 进入任务调度中心 http://10.218.170.86:8081/spdb-job-mgmt/index").append("\r\n");
	...
	public void queryCfgNas(NoteConfiguration cfg_nas, StringBuffer cfgNas) {
		...
		String city = cfg_nas.getCity();
		if("1".equals(city)) {
			cfgNas.append("SH IP：10.202.170.155").append("\r\n");
		}else if("2".equals(city)) {
			cfgNas.append("HF IP：10.122.170.155").append("\r\n");
		} else {
			cfgNas.append("SH IP：10.202.170.155").append("\r\n");
			cfgNas.append("HF IP：10.122.170.155").append("\r\n");
		}
	...
	public void queryAppNas(NoteConfiguration app_nas, StringBuffer appNas) {
		...
		if("1".equals(city)) {
			appNas.append("SH IP：10.202.170.155").append("\r\n");
		}else if("2".equals(city)) {
			appNas.append("HF IP：10.122.170.155").append("\r\n");
		} else {
			appNas.append("SH IP：10.202.170.155").append("\r\n");
			appNas.append("HF IP：10.122.170.155").append("\r\n");
		}
	...
	public void queryPublicConfigGray(NoteConfiguration commonconfig, StringBuffer publicConfig) {
		...
		String city = commonconfig.getCity();
		if("1".equals(city)) {
			publicConfig.append("SH IP：K1:(10.100.165.30)").append("\r\n");
		}else if("2".equals(city)) {
			publicConfig.append("HF IP：K1:(10.119.165.30)").append("\r\n");
		} else {
			publicConfig.append("SH IP：K1:(10.100.165.30)").append("\r\n");
			publicConfig.append("HF IP：K1:(10.119.165.30)").append("\r\n");
		}
	...
	public void queryPublicConfigProc(NoteConfiguration commonconfig, StringBuffer publicConfig) {
		...
		String city = commonconfig.getCity();
		if("1".equals(city)) {
			publicConfig.append("SH IP：K1:(10.100.165.31-32)K2:(10.202.170.133-134)").append("\r\n");
		}else if("2".equals(city)) {
			publicConfig.append("HF IP：K1:(10.119.165.31-32)(10.119.165.139)K2:(10.122.170.133-134)").append("\r\n");
		} else {
			publicConfig.append("SH IP：K1:(10.100.165.31-32)K2:(10.202.170.133-134)").append("\r\n");
			publicConfig.append("HF IP：K1:(10.119.165.31-32)(10.119.165.139)K2:(10.122.170.133-134)").append("\r\n");
		}
	...
	public List<String> queryIpListSH(String type) {
		...
		switch (type) {
		case "1":
			ipList.add("10.100.165.30");
			ipList.add("10.202.170.155");
			break;
		case "2":
			ipList.add("10.100.165.31");
			ipList.add("10.100.165.32");
			ipList.add("10.202.170.133");
			ipList.add("10.202.170.134");
			ipList.add("10.202.170.155");
			break;
		case "3":
			ipList.add("10.100.165.30");
			ipList.add("10.100.165.124");
			break;
		case "4":
			ipList.add("10.240.152.55");
			ipList.add("10.240.152.56");
			ipList.add("10.202.170.155");
			break;
		case "5":
			ipList.add("10.202.150.249");
			ipList.add("10.202.150.250");
			ipList.add("10.202.140.15");
			ipList.add("10.202.140.16");
			ipList.add("10.202.170.155");
			break;
		}
		return ipList;
	...
	public List<String> queryIpListHF(String type) {
		...
		switch (type) {
		case "1":
			ipList.add("10.119.165.30");
			ipList.add("10.122.170.155");
			break;
		case "2":
			ipList.add("10.119.165.31");
			ipList.add("10.119.165.32");
			ipList.add("10.119.165.139");
			ipList.add("10.122.170.133");
			ipList.add("10.122.170.134");
			ipList.add("10.122.170.155");
			break;
		case "3":
			ipList.add("10.119.165.30");
			ipList.add("10.100.165.125");
			break;
		case "4":
			ipList.add("10.122.186.174");
			ipList.add("10.122.186.175");
			ipList.add("10.122.170.155");
			break;
		case "5":
			ipList.add("10.122.144.249");
			ipList.add("10.122.144.250");
			ipList.add("10.122.140.15");
			ipList.add("10.122.140.16");
			ipList.add("10.122.170.155");
			break;
		}
		return ipList;
